...
def navegar_con_flechas(event):
    widget = event.widget
    if event.keysym == 'Down':
        if widget == entry_nombre:
            entry_primer_apellido.focus()
        elif widget == entry_primer_apellido:
            entry_segundo_apellido.focus()
        elif widget == entry_segundo_apellido:
            entry_telefono.focus()
        elif widget == entry_telefono:
            entry_correo.focus()
        elif widget == entry_correo:
            entry_direccion.focus()
    elif event.keysym == 'Up':
        if widget == entry_direccion:
            entry_correo.focus()
        elif widget == entry_correo:
            entry_telefono.focus()
        elif widget == entry_telefono:
...
entry_primer_apellido.bind("<Return>", navegar_con_flechas)
...
entry_segundo_apellido.bind("<Return>", navegar_con_flechas)
...
entry_telefono.bind("<Return>", navegar_con_flechas)
...
entry_correo.bind("<Return>", navegar_con_flechas)
